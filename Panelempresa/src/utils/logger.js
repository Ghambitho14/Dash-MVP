...
export const logger = {
	...
	error: (...args) => {
		console.error(...args);
		// Mejora futura: En producción, integrar servicio de logging externo (Sentry, LogRocket, etc.)
		// Esto permitirá monitoreo centralizado y alertas automáticas de errores
	},
};
